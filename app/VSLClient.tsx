        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              {/* Badge/Indicator */}
              <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-blue-200 rounded-full px-6 py-3 text-blue-700 text-sm font-medium shadow-lg mb-6">
            ...
            <div className="flex justify-center lg:justify-end relative">
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  {/* Floating Elements */}
                  <div className="absolute -top-4 -right-4 bg-gradient-to-r from-green-500 to-blue-600 text-white px-6 py-3 rounded-2xl text-sm font-bold shadow-2xl animate-pulse">
                    ✓ Natural Solution
                  </div>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h3 className="text-2xl font-light text-gray-900 mb-6">If you're a man over 40, you understand the frustration.</h3>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 md:p-12 mb-16">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <h3 className="text-2xl font-light text-gray-900 mb-4">Clinical Research & Development</h3>
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <Image
                ...
                className="mb-4"
              />
              <h4 className="text-lg font-medium text-gray-900 mb-2">Boron</h4>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <Image
                ...
                className="mb-4"
              />
              <h4 className="text-lg font-medium text-gray-900 mb-2">Tongkat Ali</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <Image
                ...
                className="mb-4"
              />
              <h4 className="text-lg font-medium text-gray-900 mb-2">Ashwagandha</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <Image
                ...
                className="mb-4"
              />
              <h4 className="text-lg font-medium text-gray-900 mb-2">Fenugreek</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <Image
                ...
                className="mb-4"
              />
              <h4 className="text-lg font-medium text-gray-900 mb-2">Panax Ginseng</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <Image
                ...
                className="mb-4"
              />
              <h4 className="text-lg font-medium text-gray-900 mb-2">Nettle Root</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-light text-gray-900 mb-6">Clinical Benefits You Can Experience</h3>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 mb-8">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-left">
                <h3 className="text-2xl font-light mb-6">Your Complete Prostate Health Package Includes:</h3>
      ...
      <section className="bg-amber-50 border-l-4 border-amber-400 py-12 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-amber-100 rounded-xl p-6 mb-6">
            <h3 className="text-2xl font-medium text-amber-800 mb-2">Limited Availability Notice</h3>
      ...
      <section className="bg-gray-50 py-8 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-sm text-gray-600 mb-2">
            Questions about ProstaVive? Our customer support team is here to help.
          </p>
          <p className="text-sm text-gray-700">
            Email: <a href="mailto:support@prostavive.org" className="text-blue-600 hover:text-blue-700 underline">support@prostavive.org</a> 
            {' '} | {' '}
            Phone: <a href="tel:863-591-4284" className="text-blue-600 hover:text-blue-700 underline">(863) 591-4284</a>
          </p>
        </div>
      </section>
    </>
